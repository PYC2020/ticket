...
//专用的测试配置类
@Configuration
@ComponentScan("com.ticket.ticketmanagement")
...
public class DaoConfiguration {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://42.192.179.180:3306/train?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Hongkong");
        dataSource.setUsername("root");
        dataSource.setPassword("pyc.0907");
        return dataSource;
    }
    ...
    public static class MyBatisMapperScannerConfig {
        ...
        public MapperScannerConfigurer mapperScannerConfig() {
            ...
            //扫描   针对每个表的mapper位置
            mapperScannerConfigurer.setBasePackage("com.ticket.ticketmanagement.mapper.impl");
            //配置通用mappers
            Properties properties = new Properties();
            //   指定通用mapper的位置，一定不能在   com.yc.piclib.dao.impl
            properties.setProperty("mappers", "com.ticket.ticketmanagement.mapper.BaseMapper");
